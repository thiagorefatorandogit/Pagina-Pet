'use client'; // <- ESSENCIAL: torna este componente um Client Component
      ...
      <div className='container mx-auto pt-16 pb-16 md:pb-0 px-4 relative'>
        ...
        <article className='grid grid-cols-1 lg:grid-cols-2 gap-8 '>
          ...
          <div className='space-y-6'>
            ...
            <div className="mt-8">
              <p className="text-sm mb-4">
                <b className="bg-black text-white px-2 py-1 rounded-md">5%</b> de desconto no primeiro atendimento do seu pet.
              </p>
          ...
          <div className='hidden md:block h-full relative'>
            ...
            fill
            sizes='(max-widht: 760px) 0vw, 50vw'
            quality={100}
            priority
            />
