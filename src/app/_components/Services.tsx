...
const services = [
  {
    ...
    icon: <Scissors />,
    linkText:
      "Ola, vi no site sobre Banho e tosa e gostaria de mias informações.",
  },
  {
    title: "Consulta Veterinaria",
    description:
      "Oferece atendimento clínico ou especializado para cuidar da saúde do animal, inclui diagnóstico de doenças, aplicação de vacinas obrigatorias.",
    duration: "1h",
    icon: <Syringe />, // unificado para "icon"
    linkText:
      "Ola , vi no site sobre consulta veterinária e gostaria de mais informações.",
  },
  {
    title: "Taxi Pet",
    description:
    ...
    linkText:
      "Ola, vi no site sobre o Táxi Pet e gostaria de mais informações.",
  },
  {
    title: "Hotel para pets",
    description:
      "Serviços de hospedagem para animais de estimação, ideal para quando os tutores, precisarem viajar ou se ausentar por alguns dias. os pets ficam acomodados em espeços seguros, confortaveis.",
    duration: "1h",
    price: "$60",
    icon: <Hotel />, // unificado para "icon"
    linkText:
      "Ola, vi no site sobre Hotem para pets e gostaria de mais informações.",
  },
];
                    ...
                    <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                      ...
                      <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                        ...
                        <a
                          target="_blank"
                          href={
                            "https://wa.me/123456789?text=Ola vim pelo site e gostaria de mais informações sobre ${item.title}"
                          }
